...
import { generateProgressBar, changeButtonStatus } from './utils.js'
            ...
            if (workouts.data.length === 0) {
                ...
                workouts.data.forEach(workout => {
                    ...
                    optionsDelete.addEventListener('click', () => {
                        ...
                        const workoutDeleteIdInput = document.getElementById('workoutDeleteId')
                        workoutDeleteIdInput.value = workout.id
