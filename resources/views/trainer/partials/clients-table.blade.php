<div>
    ...
    <div x-data="{ isDeleteModalOpen: false }" @close-modal.camel="isDeleteModalOpen = false" @open-modal.camel="isDeleteModalOpen = true" class="relative flex justify-center" id="deleteClientModal">
                ...
                <div class="relative inline-block px-4 pt-5 pb-4 overflow-hidden text-left align-bottom transition-all transform bg-white rounded-lg shadow-xl rtl:text-right dark:bg-gray-900 sm:my-8 sm:align-middle sm:max-w-sm sm:w-full sm:p-6">
                    <div>
                        ...
                        <div class="mt-2 text-center">
                            <h3 class="text-lg font-medium leading-6 text-gray-800 capitalize dark:text-white" id="modal-title">Borrar cliente</h3>
                            <p class="mt-2 text-sm text-gray-500 dark:text-gray-400">
                                Si continuas, tu relación con el cliente se borrará.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="mt-5 flex items-center justify-end">
                        ...
                        <div class="sm:flex sm:items-center ">
                            ...
                            <button id="deleteClientButton" class="w-full danger-btn">
                                Eliminar
                            </button>
                        </div>
                    </div>
