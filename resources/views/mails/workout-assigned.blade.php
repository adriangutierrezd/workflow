...
<body>
    <section
        ...
        <main style="margin-top: 2rem;">
            <h2 style="color:#374151;">{{__('Hi')}} {{ $user->name }}</h2>
    
            <p style="margin-top:0.5rem;line-height:2;color:#4B5563">
                {{$trainer->name}} {{__('has assigned you a new workout')}}: <span style="font-weight:600">{{ $workout->title }}</span>
            </p>
            ...
            <a 
                ...
                target="_blank" href="{{route('workouts.edit', $workout->id)}}">
                {{__('See workout')}}
            </a>
        </main>
