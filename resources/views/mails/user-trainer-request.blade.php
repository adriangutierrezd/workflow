...
<head>
    ...
    <style>
        ...
        *,
        ...
        padding-top: var(--tw-size-8);
        padding-bottom: var(--tw-size-8);
        margin-left: auto;
        margin-right: auto;
        --tw-bg-opacity: 1;
        ...
        :is(.dark section.mail) {
        --tw-bg-opacity: 1;
        background-color: rgb(var(--tw-color-gray-900) / var(--tw-bg-opacity));
        }

        section.mail > header > a > img {
        width: auto;
        height: var(--tw-size-7);
        }
        ...
        section.mail > main > h2 {
        --tw-text-opacity: 1;
        color: rgb(var(--tw-color-gray-700) / var(--tw-text-opacity));
        }

        :is(.dark section.mail > main > h2) {
        --tw-text-opacity: 1;
        color: rgb(var(--tw-color-gray-200) / var(--tw-text-opacity));
        }

        section.mail > main > p.mail__unique1 {
        margin-top: var(--tw-size-2);
        line-height: var(--tw-line-height-loose);
        --tw-text-opacity: 1;
        color: rgb(var(--tw-color-gray-600) / var(--tw-text-opacity));
        }

        :is(.dark section.mail > main > p.mail__unique1) {
        --tw-text-opacity: 1;
        ...
        --tw-ring-color: rgb(var(--tw-color-blue-300) / var(--tw-ring-opacity));
        --tw-ring-opacity: 0.8;
        }
        ...
        section.mail > footer > p {
        margin-top: var(--tw-size-3);
        --tw-text-opacity: 1;
        color: rgb(var(--tw-color-gray-500) / var(--tw-text-opacity));
        }

        :is(.dark section.mail > footer > p) {
        --tw-text-opacity: 1;
...
<body>
    <section class="mail">
        ...
        <main>
            <h2>{{__('Hi')}} {{ $userTrainerRequest->trainer->name }},</h2>
            ...
            <a href="{{route('user-trainer-request.accept', $userTrainerRequest->token)}}" target="_blank">
                {{__('Accept request')}}
            </a>
        ...
        <footer>
            <p>© {{date('Y')}} {{ config('app.name', 'Laravel') }}. {{__('All rights reserved')}}.</p>
        </footer>
    </section>
</body>
</html>
