...
<body>
    <main class="min-h-screen flex items-center justify-center">
        <div class="text-center">
            ...
            <h1 class="mt-4 text-3xl font-bold tracking-tight text-gray-900 sm:text-5xl">{{__('Forbidden')}}</h1>
            <p class="mt-6 text-base leading-7 text-gray-600">{{__('This area is restricted')}}</p>
