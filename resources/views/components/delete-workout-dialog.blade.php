            ...
            <div class="relative inline-block px-4 pt-5 pb-4 overflow-hidden text-left align-bottom transition-all transform bg-white rounded-lg shadow-xl rtl:text-right dark:bg-gray-900 sm:my-8 sm:align-middle sm:max-w-sm sm:w-full sm:p-6">
                <div>
                    ...
                    <div class="mt-2 text-center">
                        ...
                        <p class="mt-2 text-sm text-gray-500 dark:text-gray-400">
                            ¿Estás seguro de quieres borrar este entrenamiento? Con él se borrarán todos sus registros asociados.
                        </p>
                    </div>
                </div>
                ...
                <div class="mt-5 sm:flex sm:items-center sm:justify-between">
                    ...
                    <div class="sm:flex sm:items-center ">
                        ...
                        <button class="w-full px-4 py-2 mt-2 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-red-600 rounded-md sm:w-auto sm:mt-0 hover:bg-red-500 focus:outline-none focus:ring focus:ring-red-300 focus:ring-opacity-40">
                            Eliminar
                        </button>
                    </div>
                </div>
